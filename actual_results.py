...
try:
    ...
    df = df.merge(
        df_pred[['JoinField_norm', 'predicted_winner']],
        on='JoinField_norm', how='left'
    )
...
# ---- Boundary outlines from dedicated shapefiles ----
...
def make_visibility(show_actual, show_accuracy):
    return (
        [show_actual]   * n_actual_traces   +
        [show_accuracy] * n_accuracy_traces +
        [True]          * n_boundary_traces
    )
...
<nav>
  <div class="nav-container">
    ...
    <a href="IL09_precinct_map.html" class="nav-button">IL-09 Model</a>
